...
for i in range(3):
    ...
    checkpoint_path = "./models/parallel_experiment_only-geometry_" + str(i) + "/cp-{epoch:02d}.ckpt"
    ...
    pickle_path = "./models/parallel_experiment_only-geometry_" + str(i) + "/losses.p"
    with open(pickle_path, 'wb') as f:      
            pickle.dump(losses, f)   
    model_path = "./models/parallel_experiment_only-geometry_" + str(i) + "/final_weights"
